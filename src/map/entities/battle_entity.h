...
public:
    ...
    void addModifiers(const std::vector<CModifier>* modList);
    ...
    void addPetModifiers(const std::vector<CPetModifier>* modList);
    void delPetModifiers(const std::vector<CPetModifier>* modList);
